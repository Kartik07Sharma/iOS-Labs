 ...
 */
let friends = 200
print("Number of friend on social media: \(friends)")
...
print("Error: Cannot assign a new value to a constant declared with let.")
...
print("Can't assign new value to constants")
